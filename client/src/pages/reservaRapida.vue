<template>
    <v-container class="mt-5" max-width="600">
        <v-card>
            ...
            <v-progress-linear :model-value="(currentStep / totalSteps) * 100" color="#64942e" height="6" class="mb-2" />
            ...
            <v-card-text>
                <v-form v-model="valid" validate-on="blur">
                    ...
                    <v-row class="mt-4">
                        <v-col>
                            <v-btn v-if="currentStep > 1" @click="currentStep--; mensagem = ''" variant="outlined" block>
                                ← Anterior
                            </v-btn>
                        </v-col>
                        <v-col>
